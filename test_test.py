...
class TestTest():
  ...
  def test_test(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#navigation li:nth-child(5) span").click()
    self.driver.find_element(By.CSS_SELECTOR, ".article-basic-body > p").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".article-basic-body > p").text == "I Burlövs kommun talas det många olika språk.\\\\nDetta är en sida för dig som vill öva svenska,\\\\neller bli bättre på ditt modersmål."
    self.driver.close()
